...
<div class="container">
    ...
    </div>Copyright 2016-2018 Christopher Rieke<br><br>
    ...
    foreach ($ContributorsManual as $singleContr) {
        ...
        $manualContrList = $manualContrList . '</a>';
        $manualContrList = $manualContrList . '<p>' . $singleContr['contr'] . '</p>';
