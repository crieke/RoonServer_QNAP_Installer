...
<div class="topbar">
    <div class='wrap'>
        ...
        <ul class="topbar-items">
            <li class='topbar-item topcommunity'><a href="index.php">Info</a></li>
            <li class='topbar-item topcommunity'><a href="log.php">Live Log</a></li>

            <li class="topbar-item dropdown">
                <a href="#" class="dropdown-toggle moremenu" data-toggle="dropdown"><span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="https://roonlabs.com/downloads.html" target="_blank">Downloads</a></li>
                    <li><a href="http://community.roonlabs.com/" target="_blank">Community Site / Forums</a></li>
                    <li><a href="http://kb.roonlabs.com/Roon_Server_on_NAS" target="_blank">Roon on NAS info</a></li>
                </ul>

            </li>
            <li class="topbar-item topbar-right toptryfree tophidetrial"><a class='button' style='text-transform:none; margin-top: 14px; margin-right: 20px;' href="https://www.roonlabs.com/pricing.html" target="_blank">Try It Free</a></li>
        </ul>
    </div>
</div>
